...
import { render } from '@testing-library/react';
  ...
  function FollowUp() {
    return(
      <div>
        <section 
        style={"background-image: url(&quot;https://meetcambium.com/images/about-us-on-home-page.jpg&quot;);"} 
        // data-style="background-image: url(images/about-us-on-home-page.jpg);" 
        class="section-100 section-bottom-60 section-sm-100 bg-white bg-image"
        >
        <section class="section-100 section-bottom-60 section-sm-100 bg-white bg-image">
        <div class="shell">
          <div class="range range-condensed range-xs-center range-sm-right range-xs-middle">
            <div style="max-width:430px;" class="cell-xs-10 cell-sm-7 cell-md-6 cell-lg-5">
              <div class="box bg-cello section-relative">
                <h3 class="text-white">About Us</h3>
                <div class="offset-top-40">
                  <p class="font-size-big text-white">We are dedicated to providing professional service with the highest degree of honesty and integrity, and strive to add value through our bookkeeping and consulting services.</p>
                </div>
                <div class="offset-top-40">
                  <ul class="list-marked">
                    <li class="font-size-big text-white">Highly Competent Professionals</li>
                    <li class="font-size-big text-white">Over 20 years experience</li>
                    <li class="font-size-big text-white">Committed to Driving Growth in Your Organization</li>
                  </ul>
                </div>
                <div class="offset-top-45">
                  <a name="Contact Us Page" 
                     href="contact-us.php" 
                     class="btn btn-icon btn-icon-right btn-white-outline"
                  >
                    <span class="icon icon-xs-smaller fa-angle-right text-primary">
                    </span>Contact Us
                  </a>
                </div>
              </div>
      ...
      <section 
        data-on="false" 
        data-md-on="true" 
        style={"background-image: url(&quot;https://meetcambium.com/images/clients-testimonials-parallax-3.jpg&quot;); position: relative; overflow: hidden; z-index: 0; height: 769px;"} 
        class="rd-parallax bg-gray-base bg-image"
      >
        <div 
          class="rd-parallax-inner"  
          style={"position: absolute; top: 0px; margin-top: -60px; padding: 60px 0px; width: 1045px; transform: translate3d(0px, 534px, 0px);"}
        >
          <div 
            data-speed="0.33" 
            data-type="media" 
            ...
            style={"position: fixed; background-image: url(&quot;https://meetcambium.com/images/clients-testimonials-parallax-3.jpg&quot;); height: 982.39px; transform: translate3d(0px, -329.60999999999996px, 0px);"}
          >
          </div>
          <div 
            class="rd-parallax-layer-holder" 
            style={"position: relative; height: 769px;"}
          >
          <div 
            data-speed="0" 
            data-type="html" 
            class="rd-parallax-layer" 
            style={"position: fixed; width: 1045px; transform: translate3d(0px, 0px, 0px);"}
          >
              ...
              <div class="range offset-top-50 text-left">
                <div class="cell-xs-12">
                  <div 
                    ...
                    data-dots="true" 
                    data-dots-each="1" 
                    class="owl-carousel owl-spacing-1 owl-nav-classic owl-style-minimal owl-carousel owl-spacing-1 owl-nav-classic owl-style-minimal owl-theme owl-loaded"
                  >
                    
                  <div class="owl-stage-outer">
                    <div class="owl-stage" 
                    style={"transform: translate3d(-820px, 0px, 0px); transition: 0s; width: 3720px; padding-left: 15px; padding-right: 15px;"}>
                      <div 
                      ...
                      <blockquote class="quote-bordered">
                        <div class="quote-body">
                          ...
                          <div class="quote-body-inner">
                            <p class="text-white font-size-big">
                              <q>
                                ...Cambium Consulting has allowed me to operate my international sound engineering and concert promotion business.
                ...
                <div 
                  class="owl-item animated owl-animated-in slide active" 
                  style="width: 380px; margin-right: 30px;"
                >
                    <div class="item">
                      <blockquote class="quote-bordered">
                          ...
                          <div class="quote-body-inner">
                            ...
                            <p class="text-white font-size-big">
                              <q>...Their attention to detail and dedicated approach will exceed your expectations. They are diligent, follow through and have excellent communication skills. 
                                Best of all, they really know their stuff - you can't go wrong engaging their services.
                              </q>
                            </p>
                          </div>
                        </div>
